    ...
    <main>
      ...
      <section className="hero section-shell" id="top">
        <div className="hero-copy">
          ...
          <h1>Where high intent<br /><em>meets AI visibility.</em></h1>
        ...
        <div className="hero-portrait-wrap">
          ...
          <div className="portrait-card">
            <img src="/images/profile_standee.png" alt="Vinod Kumaran standing in a modern emerald and gold interior" />
            <div className="portrait-caption"><span>Based in India</span><span>Working globally</span></div>
          </div>
          <div className="hero-float-card"><Sparkles size={16} /><span>Building the next layer<br /><strong>of digital visibility</strong></span></div>
        </div>
      </section>
      ...
      <section className="case-study section-shell" id="journal"><div className="case-content"><div className="section-label light-label"><span>08</span><span className="label-rule" /><span>Selected work</span></div><p className="case-kicker">Healthcare · Diagnostics · Digital growth</p><h2>Neuberg<br /><em>Diagnostics.</em></h2><p>Creating a digital ecosystem that connects clinical expertise with the people actively searching for answers.</p><a className="button button-light" href={bookingUrl} target="_blank" rel="noreferrer">View case study <ExternalLink size={16} /></a></div><div className="case-visual"><div className="case-orbit" /><div className="case-monogram">N<span>D</span></div><div className="case-caption">A study in<br /><strong>high-intent growth</strong></div></div></section>
