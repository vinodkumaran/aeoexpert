...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: 'profile',
    images: [{ url: '/images/profile_standee.png', width: 1200, height: 630, alt: 'Vinod Kumaran — AI Visibility Strategist' }],
  },
  twitter: {
    ...
    description:
      'Build visibility for brands in the age of AI. AEO, GEO, AI Search & high-intent growth strategy. Book a meeting today.',
    images: ['/images/profile_standee.png'],
  },
...
const personSchema = {
  ...
  name: 'Vinod Kumaran',
  url: SITE_URL,
  image: `${SITE_URL}/images/profile_standee.png`,
